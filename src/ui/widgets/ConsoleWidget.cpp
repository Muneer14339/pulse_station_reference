...
void ConsoleWidget::buildUI() {
    ...
    rightLayout->setContentsMargins(ContentH, ContentV, ContentH, ContentV * 2);
    rightLayout->setSpacing(SectionGap);
    ...
    categoryLayout->setSpacing(InlineGap);
    ...
    actionLayout->setContentsMargins(0, SectionGap, 0, 0);
    ...
    mainLayout->addWidget(m_rightScroll, 1);
